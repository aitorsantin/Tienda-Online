    ...
    <?php
      if(isset($_GET['id']))
      {
        ...
        if($pre)
        {
          ...
          mysqli_stmt_bind_result($pre, $codArticulo, $Nombre, $precioCoste, $Imagen);
  ...
  ?>
       <div class="col-12 col-md-4 col-lg-3">
        <div class="card cartas-productos">
          <div class="card-body">
          <?php
            echo " <img src=\"../../images/".$Imagen."\" class=\"card-img-top productos-img\" alt=\"...\">";
          ?>
            <h5 class="card-title"><?php echo $Nombre; ?></h5>
            <p class="card-text p-precio">Precio: <?php echo $precioCoste; ?>€</p>
          <?php
              echo "<a href=\"producto.php?id=".$codArticulo."\"type=\"button\" class=\"btn btn-primary btn-productos\">Ver Detalle</a>";
          ?>
